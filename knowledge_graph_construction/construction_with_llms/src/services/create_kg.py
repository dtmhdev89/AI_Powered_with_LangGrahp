...
DOCS_PATH = os.path.join("src/data_sources", "course")
...
result = graph.query("RETURN 1 AS connection_test")
if result and result[0].get("connection_test") == 1:
    print("Successfully connected to Neo4j and executed a query.")
else:
    print("Connection successful, but unexpected query result.")
